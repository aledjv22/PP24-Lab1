...
## 1.1. Lenguaje
- [x] Módulo [Dibujo.hs](./src/Dibujo.hs) con el tipo `Dibujo` y combinadores. Puntos 1 a 3 de la consigna.
- [x] Definición de funciones (esquemas) para la manipulación de dibujos.
- [x] Módulo [Pred.hs](./src/Pred.hs). Punto extra si definen predicados para transformaciones innecesarias (por ejemplo, espejar dos veces es la identidad).

## 1.2. Interpretación geométrica
- [x] Módulo [Interp.hs](./src/Interp.hs).

## 1.3. Expresión artística (Utilizar el lenguaje)
- [x] El dibujo de [Dibujos/Feo.hs](./src/Dibujos/Feo.hs) se ve lindo.
- [x] Módulo [Dibujos/Grilla.hs](./src/Dibujos/Grilla.hs).
- [x] Módulo [Dibujos/Escher.hs](./src/Dibujos/Escher.hs).
- [x] Listado de dibujos en [Main.hs](./src/Main.hs) + punto extra

## 1.4 Tests
- [x] Tests para Dibujo.hs en [test/TestDibujo.hs](./test/TestDibujo.hs).
- [x] Tests para Pred.hs en [test/TestPred.hs](./test/TestPred.hs).
...
- Se agrego en [Pred.hs](./src/Pred.hs) la definicion de predicados para transformaciones innecesarias generalizadas, basicamente si la transformacion causa que se vuelva a la figura original (identidad) entonces no es necesaria y devuelve `True`.
